(function () {
  ...
  var qa = [
    ...
    { k: ['ai', 'agent', 'claude', 'mcp', 'llm', 'artificial intelligence', 'machine learning'], a: "Mikael builds AI-powered tools: autonomous agents using Claude Agent SDK for enterprise workflows, MCP servers connecting AI assistants to Apache Solr and e-commerce backends, and AI pipelines for automated product classification in e-commerce platforms.", s: ['What are his skills?', 'Tell me about his projects'] },
